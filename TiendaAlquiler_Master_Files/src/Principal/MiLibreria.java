...
public class MiLibreria {
    ...
    public static boolean validarFormatoLibro(String texto) {
        ...
        if (!(texto.equalsIgnoreCase("papel") || texto.equalsIgnoreCase("ebook"))) {
            System.err.println("El formato tiene que ser papel o ebook");
            ok = false;
        }
        return ok;
    }
    ...
    public static boolean validarPositivo(int num) {
        boolean ok = true;
        if (num < 0) {
            System.err.println("El numero debe ser positivo");
            ok = false;
        }
        return ok;
    }
    ...
    public static boolean validarFecha(String fecha) {
        ...
        int dia = 0, mes = 0, anyo = 0, diasFeb;

        if (fecha.length() != 10) {
            System.err.println("La fecha debe tener 10 caracteres de longitud");
        } else {
            s = fecha.substring(2).charAt(0);
            s1 = fecha.substring(5).charAt(0);
